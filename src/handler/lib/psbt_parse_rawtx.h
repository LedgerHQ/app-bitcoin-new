...
/**
 * Given a commitment to a merkleized map and a key, this flow parses it, computes the transaction
 * hash and computes relevant info about the tx (TODO: which info?)
 */
