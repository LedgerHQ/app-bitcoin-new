...
DEFINES   += BIP32_PUBKEY_VERSION=0x00000000 # unused
DEFINES   += BIP44_COIN_TYPES={145,0}
...
DEFINES   += COIN_COLOR_HDR=0x85bb65
DEFINES   += COIN_COLOR_DB=0xc2ddb2
...
# Initial fork from Bitcoin, public key access is authorized. Signature is different thanks to the forkId
DEFINES   += BIP32_PUBKEY_VERSION=0x00000000 # unused
DEFINES   += BIP44_COIN_TYPES={156,0}
...
DEFINES   += COIN_COLOR_HDR=0xCCCCCC
DEFINES   += COIN_COLOR_DB=0xE6E6E6
...
DEFINES   += COIN_COLOR_HDR=0x65D196
DEFINES   += COIN_COLOR_DB=0xB2E8CB
...
DEFINES   += COIN_COLOR_HDR=0x0E76AA
DEFINES   += COIN_COLOR_DB=0x87BBD5
...
DEFINES   += COIN_COLOR_HDR=0x3790CA
DEFINES   += COIN_COLOR_DB=0x9BC8E5
...
DEFINES   += COIN_COLOR_HDR=0xFF4300
DEFINES   += COIN_COLOR_DB=0xFF8356
...
DEFINES   += COIN_COLOR_HDR=0x326464
DEFINES   += COIN_COLOR_DB=0x99b2b2
...
DEFINES   += BIP44_COIN_TYPES={119,77}
...
DEFINES   += COIN_COLOR_HDR=0x46385D
DEFINES   += COIN_COLOR_DB=0x9E96AA
...
DEFINES   += COIN_COLOR_HDR=0x000000
DEFINES   += COIN_COLOR_DB=0x808080
...
DEFINES   += COIN_COLOR_HDR=0x414141
DEFINES   += COIN_COLOR_DB=0xA0A0A0
...
DEFINES   += BIP44_COIN_TYPES={28,128}
...
DEFINES   += COIN_COLOR_HDR=0x1B5C2E
DEFINES   += COIN_COLOR_DB=0x8DAE97
...
DEFINES   += COIN_COLOR_HDR=0x3EAD54
DEFINES   += COIN_COLOR_DB=0xA3DCAE
...
DEFINES   += BIP32_PUBKEY_VERSION=0x00000000 # unused
DEFINES   += BIP44_COIN_TYPES={183,0}
...
DEFINES   += COIN_COLOR_HDR=0x98C01F
DEFINES   += COIN_COLOR_DB=0xA1A2A7
...
DEFINES   += COIN_COLOR_HDR=0xc87035
DEFINES   += COIN_COLOR_DB=0xc78457
...
DEFINES   += COIN_COLOR_HDR=0x2982D1
DEFINES   += COIN_COLOR_DB=0x7FB6E6
...
DEFINES   += COIN_COLOR_HDR=0x1685e8
DEFINES   += COIN_COLOR_DB=0xffffff
...
DEFINES   += COIN_COLOR_HDR=0x38D9A9
DEFINES   += COIN_COLOR_DB=0xFEDBA9
...
DEFINES   += COIN_COLOR_HDR=0x2E4A80
DEFINES   += COIN_COLOR_DB=0x74829E
