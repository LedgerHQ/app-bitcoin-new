...
APPNAME ="xRhodium"
APP_LOAD_PARAMS += --path $(APP_PATH)
else ifeq ($(COIN),peercoin_testnet)
# Peercoin testnet
DEFINES   += BIP32_PUBKEY_VERSION=0x00000000 # unused
DEFINES   += BIP44_COIN_TYPE=1
DEFINES   += BIP44_COIN_TYPE_2=1
...
DEFINES   += COIN_NATIVE_SEGWIT_PREFIX=\"tpc\"
DEFINES   += COIN_KIND=COIN_KIND_PEERCOIN
DEFINES   += COIN_FLAGS=FLAG_PEERCOIN_UNITS\|FLAG_PEERCOIN_SUPPORT\|FLAG_SEGWIT_CHANGE_SUPPORT
APPNAME ="Peercoin Test"
APP_LOAD_PARAMS += --path $(APP_PATH)
